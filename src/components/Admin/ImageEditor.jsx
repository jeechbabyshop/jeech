...
const ImageEditor = ({ initialImage, onSave, onClose }) => {
  ...
  const getAspectRatioValue = () => {
    return aspectRatios[selectedRatio].ratio;
  };
  ...
  const updatePreview = async () => {
    const enhancedImage = await applyEnhancementsToImage(currentImage);
  ...
  const handleBackgroundRemoved = (newImageFile) => {
      ...
      <div className="fixed inset-0 z-50 bg-black flex flex-col">
        ...
        <div className="bg-white px-4 pt-24 pb-2 flex items-center justify-between border-b border-gray-200">
          ...
          <div className="flex gap-1 bg-gray-100 rounded-lg p-0.5">
            ...
            <button onClick={() => setShowBackgroundRemover(true)} className="px-4 py-1 rounded-md text-sm bg-purple-600 text-white">
              <FaEraser className="inline mr-1 text-xs" /> Remove BG
            </button>
          </div>
          <div className="w-16" />
        </div>
              ...
              {cropEnabled ? (
                <div className="flex-1 flex flex-col overflow-hidden">
                  <div className="flex-1 flex items-center justify-center p-2 bg-black">
                    <ReactCrop crop={crop} onChange={setCrop} onComplete={setCompletedCrop} aspect={getAspectRatioValue()} className="max-h-[50vh]">
                      <img ref={imgRef} src={currentImage} alt="Crop" className="max-h-[45vh] object-contain" />
                    </ReactCrop>
                  </div>
                ...
                <div className="flex-1 flex items-center justify-center p-4 bg-black">
                  <div className="text-center">
                    <img src={currentImage} alt="Full" className="max-h-[55vh] object-contain rounded" />
